...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 flex flex-col justify-between font-sans selection:bg-blue-100 selection:text-blue-900 text-slate-800 relative overflow-hidden">
      ...
      {/* Header (Same height and style as landing page) */}
      <header className="px-6 py-5 flex items-center justify-between border-b border-slate-100 bg-white/85 backdrop-blur-md z-10">
